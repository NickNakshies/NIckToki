...
<!--Profile-->
    ...
    <div class="p-4 mt-5 row ms-4 mb-3 profile-container">
        <h2 class="profile-text" style="color: #ffffffff; transform: scale(1.2); margin-left: 12%;">Profile</h2>
    </div>
    ...
    <form id="formValidate">
        <div class="row p-1 ms-1">
            ...
            <div class="col-md-5 fs-4 mt-5 ms-2 me-5 pt-5 pt-2 username-fade">
        ...
        <div class="col me-5">
            <div class="row">
                <div class="col">
                    <label style="color: #d9d9d9;">Email</label><br>
...
<div class="row">         
  <div class="col-auto mt-4 ms-5">
    <a href="/pages/Sign_In_Up/signin.html" id="logout-btn" class="profile-link fs-3 fw-bold" style="color: #0cc0df;">
